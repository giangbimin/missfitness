...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { ciruittraining: @trainer.ciruittraining, content: @trainer.content, metadescription: @trainer.metadescription, metaimage: @trainer.metaimage, metakeywords: @trainer.metakeywords, metaurl: @trainer.metaurl, pilates: @trainer.pilates, privatetraining: @trainer.privatetraining, trainername: @trainer.trainername, trx: @trainer.trx } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { ciruittraining: @trainer.ciruittraining, content: @trainer.content, metadescription: @trainer.metadescription, metaimage: @trainer.metaimage, metakeywords: @trainer.metakeywords, metaurl: @trainer.metaurl, pilates: @trainer.pilates, privatetraining: @trainer.privatetraining, trainername: @trainer.trainername, trx: @trainer.trx } }
